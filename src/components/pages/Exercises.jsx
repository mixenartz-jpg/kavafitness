...
function MuscleMapSVG({ activeGroup, onSelect }) {
  ...
  // Anatomik SVG path verileri — silüet çizgilerine hassas uyumlu poligonlar
  // Front viewBox: 0 0 347 581 — vücut merkezi x≈175
  // Back  viewBox: 0 0 346 585 — vücut merkezi x≈173
  const FRONT = {
    chest: [
      // Sol pektoral — üst kenar boyun/köprücükten, dış kenar deltoidle birleşim, alt kenar göğüs altı çizgisi
    ...
    shoulders: [
      // Sol deltoid — omzu kaplayan kas, üstte trapez sınırı, altta kol başlangıcı
    ...
    arms: [
      // Sol bicep — omuzdan dirseğe, kolun iç ve dış hattı
    ...
    core: [
      // Merkez karın (rectus abdominis) — göğüs altından kasık üstüne dar dikdörtgenimsi
      ...
      // Sol oblik — karın yanı, kaburga altından kalçaya
    ...
    legs: [
      // Sol kuadriseps — kalçadan dize, iç ve dış hat
      ...
      // Sol baldır — dizden ayak bileğine, elmas şeklinde
  ...
  const BACK = {
    back: [
      // Trapez — boyundan omuz hattına yayılan üst sırt kası
      ...
      // Sol lat — koltuk altından bele inen geniş sırt kası
      ...
      // Alt sırt (erector spinae) — belin iki yanı
    ...
    shoulders: [
      // Sol arka deltoid — omzun arka kısmı
    ...
    arms: [
      // Sol tricep — kolun arka kısmı, omuzdan dirseğe
    ...
    legs: [
      // Sol hamstring — arka uyluk, kalçadan dize
      ...
      // Sol baldır — arka bacak alt kısmı
    ...
    core: [
      // Sol glute (kalça) — belirgin yuvarlak şekil
