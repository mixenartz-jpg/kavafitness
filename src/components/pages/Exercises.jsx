...
function MuscleMapSVG({ activeGroup, onSelect }) {
  ...
  // Screenshot işaret analizinden çıkarılan gerçek polygon koordinatları
  // Her nokta muscle_front/back.png piksel koordinatı (347x581 / 346x585)
  const FRONT = {
    chest: [
      "147,85 133,91 120,96 108,102 110,113 110,124 104,140 104,157 105,162 133,173 184,162 184,135 184,107 151,96 148,85",
      "196,85 208,91 230,102 218,113 175,124 175,140 175,157 188,168 239,173 240,157 246,140 242,124 228,113 219,96 208,91 196,85",
    ],
    shoulders: [
      "105,167 86,174 80,181 74,192 76,199 101,199 111,192 122,185 139,174 142,167",
      "197,167 252,174 261,181 268,192 270,199 248,206 231,192 219,185 208,177 197,167",
    ],
    arms: [
      "74,141 55,155 43,176 28,196 9,224 0,251 0,286 25,258 49,231 72,210 91,183 97,162 98,155 91,141",
      "236,148 275,155 283,169 299,190 318,217 333,244 333,265 316,258 289,238 269,210 252,190 236,162 232,155 236,148",
    ],
    core: [
      "104,204 104,216 90,235 80,248 95,266 111,291 114,310 113,322 135,341 135,353 208,347 211,335 230,316 228,304 240,272 248,254 239,235 239,216 110,204",
    ],
    legs: [
      "116,204 111,223 107,252 102,280 98,309 96,337 102,366 104,394 101,423 95,451 95,470 99,489 104,518 110,537 123,556 128,537 129,499 133,470 148,442 157,375 163,328 178,290 141,271 135,242 120,214",
      "215,214 200,242 200,261 172,290 175,318 182,347 193,385 203,423 203,451 209,480 215,508 219,537 228,556 239,537 240,508 248,470 248,432 240,394 251,347 251,309 251,271 242,233 231,214",
    ],
  }

  const BACK = {
    back: [
      "140,133 146,144 147,156 118,168 131,180 109,192 72,204 59,222 50,240 62,252 280,252 296,240 287,222 272,204 228,186 219,174 200,150 203,138 153,133",
      "65,264 53,282 118,288 115,300 125,312 169,324 171,335 162,341 181,353 225,347 227,330 224,318 230,300 296,288 290,270 280,264",
    ],
    shoulders: [
      "105,167 86,174 80,181 74,192 76,199 101,199 119,188 129,177 142,167",
      "197,167 236,174 261,185 268,199 248,206 225,192 214,181 197,167",
    ],
    arms: [
      "74,141 55,155 43,176 28,196 9,224 0,251 0,286 32,258 55,224 75,203 91,183 97,162 91,141",
      "236,148 269,162 290,183 312,210 333,244 333,265 315,258 278,224 264,203 252,190 244,176 236,148",
    ],
    legs: [
      "116,204 111,223 107,252 102,280 98,309 96,337 102,366 104,394 101,423 95,451 95,470 99,489 104,518 122,546 128,527 133,480 148,451 157,366 178,309 178,280 141,261 128,223",
      "215,214 200,242 200,261 172,290 175,318 185,356 193,394 203,432 205,470 214,508 224,546 239,527 242,489 248,451 251,394 251,328 251,290 249,261 237,223",
    ],
    core: [
      "65,264 53,282 118,288 115,300 125,312 169,324 171,335 225,330 224,318 230,300 296,288 290,270 280,264",
    ],
  }
    ...
    <div style={{ width:'100%', maxWidth:220, margin:'0 auto' }}>
      ...
      <div style={{ position:'relative', width:'100%', lineHeight:0 }}>
        ...
        <svg viewBox={vbox} xmlns="http://www.w3.org/2000/svg"
          ...
          {Object.entries(data).map(([id, polygons]) => (
            <g key={id} onClick={() => handleSelect(id)} style={{cursor:'pointer'}}>
              {polygons.map((pts, i) => (
                <polygon key={i} points={pts} style={ps(id)}/>
              ))}
            </g>
          ))}
        </svg>
