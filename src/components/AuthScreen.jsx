...
export default function AuthScreen() {
  ...
  const [email, setEmail]     = useState('')        // gerçek e-posta (kayıt için)
  ...
  const handleLogin = async () => {
    ...
    setLoading(true)
    try {
      // Kullanıcı adından gerçek e-postayı bul
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize:12, color:'var(--text-muted)', fontFamily:'DM Mono,monospace', marginBottom:24 }}>
